...
class _CreateAccState extends State<CreateAcc> {
                    ...
                    children: [
                      ...
                      Container(
                        decoration: BoxDecoration(
                          boxShadow: [
                            BoxShadow(
                              color: const Color.fromARGB(255, 170, 29, 29)
                        ...
                        child: FilledButton(
                          ...
                          style: FilledButton.styleFrom(
                            backgroundColor: const Color.fromARGB(
                                255, 21, 20, 20), // Background color for Cancel
                      ...
                      Container(
                        decoration: BoxDecoration(
                          boxShadow: [
                            BoxShadow(
                              color: Color.fromARGB(255, 188, 40, 40)
                                  .withOpacity(0.8), // Shadow color
                              spreadRadius: 5,
                              blurRadius: 15,
                              offset: Offset(2, 4),
                        ...
                        child: FilledButton(
                          ...
                          style: FilledButton.styleFrom(
                            backgroundColor: const Color.fromARGB(
                                255, 16, 20, 16), // Background color for Save
                            padding: EdgeInsets.symmetric(
  ...
  Widget buildTextField(
    ...
    //change color of the label its the one
    return Padding(
            ...
            suffixIcon: isPasswordField
                ? IconButton(
                    ...
                    icon: Icon(
                      ...
                      color: Color.fromARGB(255, 249, 227, 227),
                    ),
                  )
                : null,
